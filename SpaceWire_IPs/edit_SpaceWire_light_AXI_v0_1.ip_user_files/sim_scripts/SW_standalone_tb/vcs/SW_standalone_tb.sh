...
#                script (type 'SW_standalone_tb.sh -help' for more information).
#
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../edit_SpaceWire_light_AXI_v0_1.gen/sources_1/bd/SW_standalone_tb/ipshared/3242" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SW_standalone_tb xil_defaultlib.glbl -o SW_standalone_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SW_standalone_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SW_standalone_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SW_standalone_tb_simv.daidir vcs_lib c.obj)
