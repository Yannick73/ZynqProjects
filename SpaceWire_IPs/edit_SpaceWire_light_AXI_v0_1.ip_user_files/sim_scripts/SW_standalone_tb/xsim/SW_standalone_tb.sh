...
#
# Script generated by Vivado on Sun Aug 18 23:06:20 +0200 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SW_standalone_tb.sh
...
#
# Usage        : SW_standalone_tb.sh
#                SW_standalone_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SW_standalone_tb.sh [-reset_run]
#                SW_standalone_tb.sh [-reset_log]
#                SW_standalone_tb.sh [-help]
#
...
# script info
echo -e "SW_standalone_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SW_standalone_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SW_standalone_tb xil_defaultlib.SW_standalone_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SW_standalone_tb -key {Behavioral:SPW_standalone:Functional:SW_standalone_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/SW_standalone_tb.protoinst" -protoinst "protoinst_files/SW_pkg_tb.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SW_standalone_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SW_standalone_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SW_standalone_tb.sh [-help]\n\
Usage: SW_standalone_tb.sh [-step]\n\
Usage: SW_standalone_tb.sh [-lib_map_path]\n\
Usage: SW_standalone_tb.sh [-reset_run]\n\
Usage: SW_standalone_tb.sh [-reset_log]\n\
Usage: SW_standalone_tb.sh [-keep_index]\n\
Usage: SW_standalone_tb.sh [-noclean_files]\n\n\
