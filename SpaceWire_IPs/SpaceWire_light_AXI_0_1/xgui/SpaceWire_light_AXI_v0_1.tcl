...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S_AXI_Stream_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
  ...
  ipgui::add_param $IPINST -name "C_S_AXI_ControlRegister_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_S_AXI_ControlRegister_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_ControlRegister_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_ControlRegister_HIGHADDR" -parent ${Page_0}
