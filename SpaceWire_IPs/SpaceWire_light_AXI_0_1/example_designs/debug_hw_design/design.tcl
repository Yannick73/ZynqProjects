...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of SpaceWire_light_AXI_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins SpaceWire_light_AXI_0/S_AXI_ControlRegister]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/s_axi_controlregister_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/s_axi_controlregister_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins SpaceWire_light_AXI_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of SpaceWire_light_AXI_0 streaming interfaces..
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/s_axi_stream_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/s_axi_stream_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Copy all address to SpaceWire_light_AXI_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/SpaceWire_light_AXI_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SpaceWire_light_AXI_0_S_AXI_ControlRegister_* ]]
	puts $fp "set s_axi_controlregister_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SpaceWire_light_AXI_0_S_AXI_INTR_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/SpaceWire_light_AXI_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "SpaceWire_light_AXI_hw_${i}"
