# Runtime Tcl commands to interact with - SpaceWire_light_AXI

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/SpaceWire_light_AXI_include.tcl
...
# Test: S_AXI_ControlRegister
# Create a write transaction at s_axi_controlregister_addr address
create_hw_axi_txn w_s_axi_controlregister_addr [get_hw_axis $jtag_axi_master] -type write -address $s_axi_controlregister_addr -data $wdata_1
# Create a read transaction at s_axi_controlregister_addr address
create_hw_axi_txn r_s_axi_controlregister_addr [get_hw_axis $jtag_axi_master] -type read -address $s_axi_controlregister_addr
# Initiate transactions
run_hw_axi r_s_axi_controlregister_addr
run_hw_axi w_s_axi_controlregister_addr
run_hw_axi r_s_axi_controlregister_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s_axi_controlregister_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - S_AXI_ControlRegister"
} else {
	puts "Data comparison test fail for - S_AXI_ControlRegister, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
