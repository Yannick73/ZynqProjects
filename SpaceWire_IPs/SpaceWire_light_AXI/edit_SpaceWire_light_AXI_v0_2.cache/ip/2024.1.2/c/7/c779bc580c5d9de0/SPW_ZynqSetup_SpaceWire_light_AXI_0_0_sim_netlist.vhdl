...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CLKDriver is
  port (
    RXCLK : out STD_LOGIC;
    SPW_Sin : in STD_LOGIC;
    SPW_Din : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CLKDriver;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CLKDriver is
  signal A : STD_LOGIC;
  attribute BOX_TYPE : string;
  attribute BOX_TYPE of CLK_BUF_INST : label is "PRIMITIVE";
begin
CLK_BUF_INST: unisim.vcomponents.BUFH
     port map (
      I => A,
      O => RXCLK
    );
CLK_BUF_INST_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpaceWire_light_AXI_master_stream_v0_2_AXI_StreamOut is
  ...
  attribute SOFT_HLUTNM of \M_AXIS_TDATA[7]__0_i_1\ : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of M_AXIS_TVALID_i_1 : label is "soft_lutpair86";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpaceWire_light_AXI_slave_stream_v0_2_AXI_StreamIn is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \char_fifo[2]_i_1\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \char_fifo[3]_i_1\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \char_fifo[4]_i_1\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \char_fifo[6]_i_3\ : label is "soft_lutpair87";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwLink is
  ...
  attribute SOFT_HLUTNM of \reset_reg[1]_i_1\ : label is "soft_lutpair14";
...
\reset_reg[1]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwRecv is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_state_seq[state][2]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \FSM_onehot_state_seq[state][3]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \FSM_onehot_state_seq[state][4]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \FSM_onehot_state_seq[state][5]_i_11\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \FSM_onehot_state_seq[state][5]_i_3\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \FSM_onehot_state_seq[state][5]_i_9\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][0]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][1]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][3]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][4]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][5]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][6]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][7]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][8]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][8]_i_2\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][9]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \res_seq[bitcnt][9]_i_3\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \res_seq[control]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \res_seq[datareg][5]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \res_seq[datareg][6]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \res_seq[datareg][7]_i_2\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \res_seq[datareg][7]_i_3\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \res_seq[disccnt][1]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \res_seq[disccnt][2]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \res_seq[disccnt][3]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \res_seq[disccnt][5]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \res_seq[disccnt][6]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \res_seq[disccnt][6]_i_3\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \res_seq[erresc]_i_2\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \res_seq[errpar]_i_2\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \res_seq[gotfct]_i_3\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \res_seq[null_seen]_i_3\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \res_seq[pendfct][0]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \res_seq[pendfct][1]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \res_seq[rxchar]_i_2\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \res_seq[rxemptydiscard]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \res_seq[rxpacket]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \res_seq[tick_out]_i_3\ : label is "soft_lutpair34";
begin
  Q(0) <= \^q\(0);
  WEN <= \^wen\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncDff is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \res_seq[sent_fct]_i_2\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \res_seq[tokmux]_i_2\ : label is "soft_lutpair43";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncDff_4 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \restx_seq[txclkdiv][0]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \restx_seq[txdivnorm]_i_1\ : label is "soft_lutpair44";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncDff_5 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \restx_seq[b_update]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \restx_seq[c_esc]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \restx_seq[e_count][9]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \restx_seq[e_valid]_i_1\ : label is "soft_lutpair45";
begin
...
begin
\buf_ff0_i_1__1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"C5"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncDff_8 is
  ...
  signal syncdff_ff1_reg_n_0 : STD_LOGIC;
begin
buf_ff0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"335ACC5A"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncDff_9 is
  ...
  signal syncdff_ff1_reg_n_0 : STD_LOGIC;
begin
\buf_ff0_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"335ACC5A"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwRecovClk is
  port (
    RXCLK : out STD_LOGIC;
    SPW_Sin : in STD_LOGIC;
    SPW_Din : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwRecovClk;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwRecovClk is
begin
RXCLKBUF: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CLKDriver
     port map (
      RXCLK => RXCLK,
      SPW_Din => SPW_Din,
      SPW_Sin => SPW_Sin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwRecvFront is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \resrx_seq[headptr][1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \resrx_seq[headptr][2]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \resrx_seq[headptr_gray][0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \resrx_seq[headptr_gray][1]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of rxcnt_ddr : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \rxcnt_f[1]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \rxcnt_f[2]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \rxcnt_f[3]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \rxcnt_r[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \rxcnt_r[3]_i_1\ : label is "soft_lutpair22";
begin
...
rxcnt_ddr: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwXmit_fast is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \res_seq[pend_char]_i_2\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \res_seq[token1][char][0]_i_1\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \res_seq[token1][char][1]_i_1\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \res_seq[token1][char][2]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \res_seq[token1][char][3]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \res_seq[token1][char][4]_i_1\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \res_seq[token1][char][5]_i_1\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \res_seq[token1][char][6]_i_1\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \res_seq[token1][char][7]_i_1\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \res_seq[token1][fctpiggy]_i_2\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \res_seq[token1][fctpiggy]_i_3\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \res_seq[tokmux]_i_3\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \res_seq[txdivnorm]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \res_seq[txdivreg][0]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \res_seq[txdivsafe]_i_1\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \res_seq[txdivtmp][0]_i_1\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \res_seq[txdivtmp][1]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \res_seq[txenreg]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][0]_i_1\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][1]_i_1\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][2]_i_1\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][3]_i_1\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][4]_i_1\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][5]_i_1\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][6]_i_1\ : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of \restx_seq[b_token][char][7]_i_1\ : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of \restx_seq[b_token][fct]_i_1\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \restx_seq[b_token][fctpiggy]_i_1\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \restx_seq[c_bits][3]_i_1\ : label is "soft_lutpair83";
  attribute SOFT_HLUTNM of \restx_seq[c_bits][4]_i_1\ : label is "soft_lutpair83";
  attribute SOFT_HLUTNM of \restx_seq[c_bits][5]_i_1\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \restx_seq[c_bits][6]_i_1\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \restx_seq[c_bits][7]_i_1\ : label is "soft_lutpair81";
  attribute SOFT_HLUTNM of \restx_seq[c_bits][8]_i_1\ : label is "soft_lutpair81";
  ...
  attribute SOFT_HLUTNM of \restx_seq[d_bits][3]_i_1\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of \restx_seq[e_count][1]_i_1\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \restx_seq[e_count][2]_i_1\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \restx_seq[e_count][3]_i_1\ : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \restx_seq[e_count][4]_i_1\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \restx_seq[e_count][5]_i_1\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \restx_seq[e_count][6]_i_1\ : label is "soft_lutpair75";
  attribute SOFT_HLUTNM of \restx_seq[e_count][7]_i_1\ : label is "soft_lutpair75";
  ...
  attribute SOFT_HLUTNM of \restx_seq[e_shift][2]_i_1\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \restx_seq[e_shift][3]_i_1\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \restx_seq[e_shift][4]_i_1\ : label is "soft_lutpair77";
  attribute SOFT_HLUTNM of \restx_seq[e_shift][5]_i_1\ : label is "soft_lutpair77";
  attribute SOFT_HLUTNM of \restx_seq[e_shift][6]_i_1\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \restx_seq[e_shift][7]_i_1\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \restx_seq[e_shift][8]_i_1\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \restx_seq[e_shift][9]_i_1\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \restx_seq[f_spwdo]_i_1\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][0]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][1]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][2]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][3]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][4]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][5]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][6]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \restx_seq[txclkcnt][7]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \restx_seq[txclkcy][0]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \restx_seq[txclkcy][1]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \restx_seq[txclkcy][2]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \restx_seq[txclkdone][0]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \vtx[d_cnt10]\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \vtx[f_spwso]\ : label is "soft_lutpair55";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwStream is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \escape_fifo[7]_i_1\ : label is "soft_lutpair84";
  attribute ADDER_THRESHOLD : integer;
  ...
  attribute SOFT_HLUTNM of \out_fifo[6]_i_1\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \out_fifo[7]_i_2\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \out_fifo[7]_i_3\ : label is "soft_lutpair84";
...
RECOV_CLK_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpwRecovClk
     port map (
      RXCLK => rxclk,
      SPW_Din => SPW_Din,
      SPW_Sin => SPW_Sin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of SPW_TX_clk : signal is "XIL_INTERFACENAME SPW_TX_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN SPW_ZynqSetup_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  attribute x_interface_info of SPW_main_clk : signal is "xilinx.com:signal:clock:1.0 SPW_main_clk CLK";
  attribute x_interface_parameter of SPW_main_clk : signal is "XIL_INTERFACENAME SPW_main_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN SPW_ZynqSetup_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
