...
#ifndef _Test_Implementaiton_xlconcat_0_0_core_h_
#define _Test_Implementaiton_xlconcat_0_0_core_h_
...
class Test_Implementaiton_xlconcat_0_0_core : public sc_module 
{
    public: 
       Test_Implementaiton_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(Test_Implementaiton_xlconcat_0_0_core);
    ...
    virtual ~Test_Implementaiton_xlconcat_0_0_core() = default;
