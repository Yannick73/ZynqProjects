...
HD_PWD='F:/Xilinx/ZynqProjects/SpaceWire_IPs/SpaceWire_light_AXI/edit_SpaceWire_light_AXI_v0_2.runs/Test_Implementaiton_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_Implementaiton_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_Implementaiton_clk_wiz_0_0.tcl
