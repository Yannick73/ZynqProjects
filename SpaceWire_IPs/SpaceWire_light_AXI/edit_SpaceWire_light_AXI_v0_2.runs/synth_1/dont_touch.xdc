...
set_property KEEP_HIERARCHY SOFT [get_cells [split [join [get_cells -hier -filter {REF_NAME==Test_Implementaiton_clk_wiz_0_0 || ORIG_REF_NAME==Test_Implementaiton_clk_wiz_0_0} -quiet] {/inst } ]/inst ] -quiet] -quiet
...
#dup# set_property KEEP_HIERARCHY SOFT [get_cells [split [join [get_cells -hier -filter {REF_NAME==Test_Implementaiton_clk_wiz_0_0 || ORIG_REF_NAME==Test_Implementaiton_clk_wiz_0_0} -quiet] {/inst } ]/inst ] -quiet] -quiet
