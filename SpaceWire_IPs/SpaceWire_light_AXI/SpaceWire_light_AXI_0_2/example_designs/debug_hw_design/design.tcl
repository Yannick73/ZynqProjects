...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins SpaceWire_light_AXI_0/AXI_Register]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/axi_register_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/axi_register_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of SpaceWire_light_AXI_0 streaming interfaces..
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/axi_streamin_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/axi_streamin_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/axi_streamout_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_light_AXI_0/axi_streamout_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SpaceWire_light_AXI_0_AXI_Register_* ]]
	puts $fp "set axi_register_addr ${offset}"
