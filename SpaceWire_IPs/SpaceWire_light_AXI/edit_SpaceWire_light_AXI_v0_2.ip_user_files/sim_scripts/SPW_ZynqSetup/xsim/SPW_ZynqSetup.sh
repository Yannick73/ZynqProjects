...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L SPWIP -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_10 -L lib_fifo_v1_0_19 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_34 -L axi_sg_v4_1_18 -L axi_dma_v7_1_33 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_32 -L axi_data_fifo_v2_1_31 -L axi_crossbar_v2_1_33 -L axi_vip_v1_1_18 -L processing_system7_vip_v1_0_20 -L proc_sys_reset_v5_0_15 -L axi_protocol_converter_v2_1_32 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SPW_ZynqSetup xil_defaultlib.SPW_ZynqSetup xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SPW_ZynqSetup -key {Behavioral:sim_1:Functional:SPW_ZynqSetup} -tclbatch cmd.tcl -protoinst "protoinst_files/SPW_ZynqSetup.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SPW_ZynqSetup.wdb xsim.dir libdpi.so)
