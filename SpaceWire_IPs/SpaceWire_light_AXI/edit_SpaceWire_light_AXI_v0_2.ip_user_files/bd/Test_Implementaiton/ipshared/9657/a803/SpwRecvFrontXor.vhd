...
architecture SpwRecvFront_rtl of SpwRecvFront is 
   ...
   signal ff_pre_r          : std_ulogic;                             --!!! buffer for the SPW_DI buffered before the rising clock
   signal ff_pre_f          : std_ulogic;                             --!!! buffer for the SPW_DI buffered before the falling clock
   signal ff_update_clk_buf : std_ulogic;
