...
HD_PWD='F:/Xilinx/Projects/UART_Adder/UART_Adder.runs/UART_Adder_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_Adder_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_Adder_rst_ps7_0_100M_0.tcl
