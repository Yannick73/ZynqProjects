...
HD_PWD='F:/Xilinx/Projects/UART_Adder/UART_Adder.runs/UART_Adder_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_Adder_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_Adder_processing_system7_0_0.tcl
