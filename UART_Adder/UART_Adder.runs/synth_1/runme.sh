...
HD_PWD='C:/Xilinx/ZynqProjects/UART_Adder/UART_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_Adder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_Adder_wrapper.tcl
