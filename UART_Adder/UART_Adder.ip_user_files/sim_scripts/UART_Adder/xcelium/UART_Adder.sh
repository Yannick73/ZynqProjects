...
#
# Script generated by Vivado on Thu Jul 25 17:39:06 +0200 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : UART_Adder.sh
...
#
# Usage        : UART_Adder.sh
#                UART_Adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                UART_Adder.sh [-reset_run]
#                UART_Adder.sh [-reset_log]
#                UART_Adder.sh [-help]
#
...
#                script (type 'UART_Adder.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_pkg_v1_0_4 -libname lib_srl_fifo_v1_0_4 -libname lib_cdc_v1_0_3 -libname axi_uartlite_v2_0_35 -libname proc_sys_reset_v5_0_15 -libname generic_baseblocks_v2_1_2 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_register_slice_v2_1_31 -libname axi_protocol_converter_v2_1_31 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xil_defaultlib axi_lite_ipif_v3_0_4 lib_pkg_v1_0_4 lib_srl_fifo_v1_0_4 lib_cdc_v1_0_3 axi_uartlite_v2_0_35 proc_sys_reset_v5_0_15 generic_baseblocks_v2_1_2 fifo_generator_v13_2_10 axi_data_fifo_v2_1_30 axi_register_slice_v2_1_31 axi_protocol_converter_v2_1_31)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "UART_Adder.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./UART_Adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_31 $xmvlog_opts +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.UART_Adder xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.UART_Adder -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log UART_Adder_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./UART_Adder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: UART_Adder.sh [-help]\n\
Usage: UART_Adder.sh [-step]\n\
Usage: UART_Adder.sh [-lib_map_path]\n\
Usage: UART_Adder.sh [-reset_run]\n\
Usage: UART_Adder.sh [-reset_log]\n\
Usage: UART_Adder.sh [-keep_index]\n\
Usage: UART_Adder.sh [-noclean_files]\n\n\
