...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/ec67/hdl" +incdir+"../../../../UART_Adder.gen/sources_1/bd/UART_Adder/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.UART_Adder xil_defaultlib.glbl -o UART_Adder_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./UART_Adder_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key UART_Adder_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc UART_Adder_simv.daidir vcs_lib c.obj)
