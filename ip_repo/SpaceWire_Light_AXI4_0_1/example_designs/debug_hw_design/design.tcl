...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of SpaceWire_Light_AXI4_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins SpaceWire_Light_AXI4_0/AXI_registers]
	connect_bd_net [get_bd_pins SpaceWire_Light_AXI4_0/axi_registers_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_Light_AXI4_0/axi_registers_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins SpaceWire_Light_AXI4_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins SpaceWire_Light_AXI4_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SpaceWire_Light_AXI4_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	connect_bd_net [get_bd_pins SpaceWire_Light_AXI4_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Copy all address to SpaceWire_Light_AXI4_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/SpaceWire_Light_AXI4_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SpaceWire_Light_AXI4_0_AXI_registers_* ]]
	puts $fp "set axi_registers_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SpaceWire_Light_AXI4_0_S_AXI_INTR_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/SpaceWire_Light_AXI4_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "SpaceWire_Light_AXI4_hw_${i}"
