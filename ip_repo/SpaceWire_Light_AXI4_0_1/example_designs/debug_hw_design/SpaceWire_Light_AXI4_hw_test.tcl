# Runtime Tcl commands to interact with - SpaceWire_Light_AXI4

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/SpaceWire_Light_AXI4_include.tcl
...
# Test: AXI_registers
# Create a write transaction at axi_registers_addr address
create_hw_axi_txn w_axi_registers_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_registers_addr -data $wdata_1
# Create a read transaction at axi_registers_addr address
create_hw_axi_txn r_axi_registers_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_registers_addr
# Initiate transactions
run_hw_axi r_axi_registers_addr
run_hw_axi w_axi_registers_addr
run_hw_axi r_axi_registers_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_axi_registers_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - AXI_registers"
} else {
	puts "Data comparison test fail for - AXI_registers, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
