...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_AXI_registers_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_AXI_registers_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_AXI_registers_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_AXI_registers_HIGHADDR" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_AXI_registers_DATA_WIDTH { PARAM_VALUE.C_AXI_registers_DATA_WIDTH } {
	# Procedure called to update C_AXI_registers_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_registers_DATA_WIDTH { PARAM_VALUE.C_AXI_registers_DATA_WIDTH } {
	# Procedure called to validate C_AXI_registers_DATA_WIDTH
	return true
}

proc update_PARAM_VALUE.C_AXI_registers_ADDR_WIDTH { PARAM_VALUE.C_AXI_registers_ADDR_WIDTH } {
	# Procedure called to update C_AXI_registers_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_registers_ADDR_WIDTH { PARAM_VALUE.C_AXI_registers_ADDR_WIDTH } {
	# Procedure called to validate C_AXI_registers_ADDR_WIDTH
	return true
}

proc update_PARAM_VALUE.C_AXI_registers_BASEADDR { PARAM_VALUE.C_AXI_registers_BASEADDR } {
	# Procedure called to update C_AXI_registers_BASEADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_registers_BASEADDR { PARAM_VALUE.C_AXI_registers_BASEADDR } {
	# Procedure called to validate C_AXI_registers_BASEADDR
	return true
}

proc update_PARAM_VALUE.C_AXI_registers_HIGHADDR { PARAM_VALUE.C_AXI_registers_HIGHADDR } {
	# Procedure called to update C_AXI_registers_HIGHADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_registers_HIGHADDR { PARAM_VALUE.C_AXI_registers_HIGHADDR } {
	# Procedure called to validate C_AXI_registers_HIGHADDR
	return true
}
...
proc update_MODELPARAM_VALUE.C_AXI_registers_DATA_WIDTH { MODELPARAM_VALUE.C_AXI_registers_DATA_WIDTH PARAM_VALUE.C_AXI_registers_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_AXI_registers_DATA_WIDTH}] ${MODELPARAM_VALUE.C_AXI_registers_DATA_WIDTH}
}

proc update_MODELPARAM_VALUE.C_AXI_registers_ADDR_WIDTH { MODELPARAM_VALUE.C_AXI_registers_ADDR_WIDTH PARAM_VALUE.C_AXI_registers_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_AXI_registers_ADDR_WIDTH}] ${MODELPARAM_VALUE.C_AXI_registers_ADDR_WIDTH}
}
