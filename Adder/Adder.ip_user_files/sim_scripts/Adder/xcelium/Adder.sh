...
#
# Script generated by Vivado on Wed Jul 03 23:45:41 CEST 2024
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname c_reg_fd_v12_0_9 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_pipe_v3_0_9 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_addsub_v3_0_9 -libname c_addsub_v12_0_18 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "Adder.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvhdl -work c_reg_fd_v12_0_9 -V93 $xmvhdl_opts \
  ...
  xmvhdl -work xbip_addsub_v3_0_9 -V93 $xmvhdl_opts \
  "../../../../Adder.gen/sources_1/bd/Adder/ipshared/cb89/hdl/xbip_addsub_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work c_addsub_v12_0_18 -V93 $xmvhdl_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/yannick/Vivado/Adder/Adder.cache/compile_simlib/xcelium"
  fi
