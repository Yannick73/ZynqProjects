...
HD_PWD='F:/Xilinx/ZynqProjects/SpaceWire_light_OC/SpaceWire_light_OC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpwStream.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpwStream.tcl
